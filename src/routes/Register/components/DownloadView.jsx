            ...
            <div className='row'>
              <ul className='thumbnails'>
                <li className='col-md-4'>
                  <p >Linux AMD64</p>
                  <a href='/download/tix_unix_amd64.deb' className='thumbnail'>
                    <img
                      width='150'
                      alt='Linux'
                      src={LinuxLogo}
                ...
                <li className='col-md-4'>
                  <p >Linux i386</p>
                  <a href='/download/tix_unix_i386.deb' className='thumbnail'>
                    <img
                      width='150'
                      alt='Linux'
                      src={LinuxLogo}
                ...
                <li className='col-md-4'>
                  <p>OSX</p>
                  <a href='/download/tix_osx.dmg' className='thumbnail'>
